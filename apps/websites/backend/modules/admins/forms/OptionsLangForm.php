...
class OptionsLangForm extends \Phalcon\Forms\Form
{
    public function initialize($entity = null, $lang = null)
    {
        ...
        $logotext = new Hidden('logotext');
        $logotext->setLabel('<i class="fas fa-image mr-1"></i>Logo');
        $logotext->setUserOption('attr','image');
        $attr = cFL($attr,$lang,'logotext');
        $logotext->setAttributes($attr);
        $this->add($logotext);
    }
}
