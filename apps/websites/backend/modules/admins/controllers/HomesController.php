...
class HomesController  extends \BackendController {
    ...
    public function updateAction(){
        ...
        $pVdTitle = $this->request->getPost('vdtitle',['string','trim']);
        $pVideo1	 = $this->request->getPost('video1',['trim']);
        $pVideo2	 = $this->request->getPost('video2',['trim']);
        foreach ($languages as $key => $lang) {
            ...
            $itemsLang->vdtitle = !empty($pVdTitle[$lang->id]) ? $pVdTitle[$lang->id] : $pVdTitle[$lId];
            $itemsLang->video1 = !empty($pVideo1[$lang->id]) ? $pVideo1[$lang->id] : $pVideo1[$lId];
            $itemsLang->video2 = !empty($pVideo2[$lang->id]) ? $pVideo2[$lang->id] : $pVideo2[$lId];
