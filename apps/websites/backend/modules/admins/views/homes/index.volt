            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title text-primary"><i class="fas fa-newspaper mr-1"></i>Video</h3>
                            </div>
                                ...
                                <div class="card card-primary card-outline card-outline-tabs mb-0">
                                    <div class="card-header p-0 border-bottom-0">
                                        <ul class="nav nav-tabs w-100">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link {{ !key ? 'active' : '' }}" href="#vdlang{{lang.id}}" data-toggle="tab" data-tab="{{lang.id}}">
                                                    {{lang.name}}
                                                </a>
                                            </li>
                                            {% endfor %}
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            {% for key, lang in languages %}
                                            <div class="tab-pane fade {{ !key ? 'active show' : '' }}" id="vdlang{{lang.id}}">
                                                <div class="form-group label-floating w-100">
                                                    <div class="input-group">
                                                        <label class="control-label">{{formsLang[lang.id].getLabel('vdtitle')}}</label>
                                                        {{formsLang[lang.id].render('vdtitle')}}
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                </div>
                                                <div class="form-group label-floating w-100">
                                                    <div class="input-group">
                                                        <label class="control-label">{{formsLang[lang.id].getLabel('video1')}}</label>
                                                        {{formsLang[lang.id].render('video1')}}
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                </div>
                                                <div class="form-group label-floating w-100 pb-0">
                                                    <div class="input-group">
                                                        <label class="control-label">{{formsLang[lang.id].getLabel('video2')}}</label>
                                                        {{formsLang[lang.id].render('video2')}}
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                </div>
                                            </div>
