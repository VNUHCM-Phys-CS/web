            ...
            <div id="slider-banner-fullwidth" class="slider-banner-fullwidth rev_slider" data-version="5.0">
                <ul class="slides">
                    ...
                    <li data-transition="random" data-slotamount="default" data-masterspeed="default" data-title="<?= $banner->title ?>">
                        ...
                        <img src="<?= $this->helper->getLinkImage($banner->image, '/assets/frontend/images/banner1.png') ?>" alt="<?= $banner->title ?>"
                        ...
                        <div class="tp-caption sfb fadeout caption-box text-left rounded mb-5"
                            ...
                            <div class="text-right"><a class="btn btn-small btn-default margin-clear" href="<?= $banner->link ?>"><?= $this->ml->_ml('detail', 'Chi tiết') ?></a></div>
                        </div>
                    </li>
                    <?php } ?>
                </ul>
                    ...
                    <div class="home-post">
                        ...
                        <div class="media mb-3">
                            <div class="overlay-container rounded">
                                <img class="media-object border rounded grow" src="<?= $this->helper->getLinkImage($post->image) ?>" alt="<?= $post->title ?>">
                            </div>
                            <div class="media-body ml-3">
                                <h5 class="media-heading"><a href="<?= \Posts::getUrl($dept, $post) ?>" title="<?= $post->title ?>"><?= $post->title ?></a></h5>
                                <div class="small"><i class="fa fa-calendar pr-10"></i><?= $this->helper->datetimeVn($post->calendar, 'd/m/Y') ?></div>
                            </div>
                        </div>
                        <?php } ?>
                    </div>
                    <footer class="clearfix">
                        <div class="link pull-right small"><i class="fa fa-link pr-1"></i><a href="<?= Categories::getUrl($dept, $cat) ?>"><?= $this->ml->_ml('more', 'Xem thêm') ?></a></div>
                    </footer>
                </div>
            </div>
            <?php } ?>
            <div class="col-lg-3 col-md-3">
                <h3><span class="text-default text-uppercase"><?= $home['vdtitle'] ?></span></h3>
                <div class="separator-2"></div>
                <div class="homeVideo1 mb-2">
                    <?= $home['video1'] ?>
                </div>
                <div class="homeVideo2">
                    <?= $home['video2'] ?>
                </div>
            </div>
        </div>
...
<?php if ($depts->count()) { ?>
<section class="pt-5 pb-5 section dark-translucent-bg fixed-bg" style="background-position: 50% 42%; background-image: url(<?= $this->helper->getLinkImage($home['szedbg'], '/img/banner-page.jpg') ?>)">
    <?php if ($home['szedtitle']) { ?>
    <div class="container mt-4">
        ...
        <div class="col-lg-3 col-md-6 isotope-item mb-20">
            <div class="image-box shadow-2 bordered text-center h-100">
                <div class="overlay-container rounded overlay-visible h-100">
                    <img src="<?= $this->helper->getLinkImage($dept_item->image, '/img/default2.jpg') ?>" class="grow h-100" alt="<?= $dept_item->title ?>">
...
<section class="clearfix pt-5 pb-5">
    <div class="container">
            ...
            <div class="col-md-4">
                <div class="image-box team-member shadow-2 mb-20">
                    <div class="overlay-container border rounded overlay-visible">
                        <img width="100%" class="object-fit-fill grow" src="<?= $this->helper->getLinkImage($staff->image, '/img/default3.jpg') ?>" alt="<?= $staff->title ?>">
        ...
        <div class="col-lg-12 text-center">
            ...
            <a href="<?= $staff_link ?>" class="btn btn-default btn-lg btn-animated radius-50"><?= $this->ml->_ml('more', 'Xem thêm') ?> <i class="fa fa-arrow-right"></i></a>
        </div>
    </div>
</section>
<?php } ?>
...
<section class="pt-5 pb-5 section dark-translucent-bg fixed-bg" style="background-position: 50% 42%; background-image: url(<?= $this->helper->getLinkImage($home['partnerbg'], '/img/banner-page.jpg') ?>)">
    <?php if ($home['partnertitle']) { ?>
        ...
        <div class="slick-carousel carousel-5">
            ...
            <div class="col-auto">
                <div class="ph-20 feature-box text-center">
                    <span class="icon large circle"><img class="rounded-circle" alt="<?= $partner->title ?>" src="<?= $this->helper->getLinkImage($partner->image, '/assets/frontend/images/beauty.jpg') ?>"></span>
                    <h3><?= $partner->title ?></h3>
                </div>
            </div>
            <?php } ?>
