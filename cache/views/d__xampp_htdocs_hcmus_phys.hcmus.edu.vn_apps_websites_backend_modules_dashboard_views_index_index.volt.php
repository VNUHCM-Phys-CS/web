                                ...
                                <div class="card-body p-2">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php foreach ($newestPost as $post) { ?>
                                                <tr>
                                                    <td class="align-middle"><img src="<?= $this->helper->getLinkImage($post->image) ?>" alt="<?= $post->title ?>" class="img-size-50"></td>
                                                    <td class="align-middle"><a target="_blank" href="<?= Posts::getUrl($depts, $post) ?>"><?= $post->title ?></a></td>
                                                    <td class="align-middle"><span class="badge badge-info float-right"><?= $this->helper->dateVn($post->calendar, 'd/m/Y H:i') ?></span></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
